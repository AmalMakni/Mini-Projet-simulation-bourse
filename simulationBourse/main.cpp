...
//    //Date d1(25,12,2016), d2(31,12,2016);
//    //Date d1(4,1,2010), d2(29,4,2015);
//
//    vector<PrixJournalier> v=p.lirePrixJournaliersDUnFichier
//    ("C:\\Users\\21625\\Documents\\2022-2023\\MP C++\\Mini-Projet-simulation-bourse\\simulationBourse\\prices_simple.csv");
//    BourseVecteurOptimisee b2(d1,v);
...
//    auto stats = Simulation::executer(b3, trader5, d1, d2, 1000);
            ...
            switch (choix){
                case 1:
                    do {
                        ...
                        datedebut=d1;
                        if (datedebut<d2)
                                cout<<"La date de debut doit etre superieure ou egale au 14/1/2010. Veuillez reessayer."<<endl;
                        if (d3<datedebut)
                                cout<<"La date de debut doit etre inferieure ou egale au 31/12/2016. Veuillez reessayer."<<endl;
                    }while(datedebut.dateValide()== false || datedebut<d2 || d3<datedebut);
                    system("pause");
                    break;
                case 2:
                    do {
                        ...
                        if (d3<datedebut)
                                cout<<"La date de debut doit etre inferieure ou egale au 31/12/2016. Veuillez reessayer."<<endl;
                    }while(datefin.dateValide()== false || datefin<datedebut || datedebut<d2 || d3<datedebut);
                    system("pause");
                    break;
                case 3:
